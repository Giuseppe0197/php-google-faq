...
<body>
    <header>
        ...
        <div class="menu">
            ...
            <ul class="menuAsk">
                ...
                <li>Tecnologie</li>
                <li id="ask">Domande frequenti</li>
            </ul>
    ...
    <div class="container">
        ...
        <?php 
            ...
            foreach($googleArr as $googleStrings){

                echo "<div class='faq'>" . "<h2>" . $googleStrings['title'] . "</h2>" . "</div>";

                $paragraphs = explode("<br>", $googleStrings['text']);

                foreach($paragraphs as $googlestring){
                    echo "<p>" . $googlestring . "</p>";
                }
